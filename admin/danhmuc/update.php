                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="index.php?act=update_cate" method="post">
                            <input type="hidden" class="form-control fs-3" name="id-product-category" value="<?= $category_item['id']; ?>">
                            <div class="mb-3">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary fs-4"
                                    data-bs-dismiss="modal"><a style="color:white;" href="index.php?act=listcategory">Đóng</a></button>
