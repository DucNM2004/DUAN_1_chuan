                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" min="0" class="form-control fs-3" id="sale"
                                    placeholder="Giảm giá sản phẩm" name="saleOff" >
                            </div>
                            <div class="mb-3">
                                <label for="picture" class="form-label fs-3">Hình ảnh sản phẩm</label>
                                <input class="form-control fs-3" type="file" id="picture" name="picture" >
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input name="quantity" placeholder="Số lượng sản phẩm" class="form-control fs-3" id="quantity" />
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="number" min="0" value='0' class="form-control fs-3" id="sale"
                                    placeholder="Lượt xem sản phẩm" name="view_number" >
                            </div>
                            <div class="mb-3">
