...
<main class="content-wrapper">
    ...
    <div class="row mt-3">
            ...
            <div class="col-sm-12 col-md-6">
                <form action="index.php?act=admin_info" method="POST" enctype="multipart/form-data" >
                    ...
                    <div class="mb-3 fs-3">
                        ...
                        <input type="hidden" name="picture-old" id="picture" value="<?= $_SESSION['picture']?>">
                        <img src="../customer/<?= $_SESSION['picture']?>"  class="body__image img_item" />
                    </div>
                    <div class="mb-3 fs-3">
            ...
            <div class="col-sm-12 col-md-6">
                ...
                <?php } else { ?>
                    <img src="../customer/<?= $_SESSION['picture']; ?>" alt="" style="height: 300px; width: 300px; object-fit: cover;"
