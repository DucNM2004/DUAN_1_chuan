...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 27, 2023 lúc 01:36 PM
...
(63, 'Zara CROPPED SHIRT', 450, 8, '1670417693.webp', '2023-11-27 12:14:00', 'Fashion has always been so temporary and uncertain. You can’t keep up with it.  This social phenomenon is very whimsical, thus we as consumers always try to stay in touch with all the latest fashion tendencies.', 55, 1377, 25),
...
(76, 'T-shrit contestant', 3000, 60, '1700486205.webp', '2023-11-27 12:16:33', 'Super new ', 6, 38, 26),
...
--
ALTER TABLE `cart`
  ADD CONSTRAINT `id_user` FOREIGN KEY (`id_user`) REFERENCES `customer` (`id`);

--
-- Các ràng buộc cho bảng `cart_detail`
--
ALTER TABLE `cart_detail`
  ADD CONSTRAINT `id_c` FOREIGN KEY (`id_cart`) REFERENCES `cart` (`id`),
  ADD CONSTRAINT `id_p` FOREIGN KEY (`id_pro`) REFERENCES `product` (`id`),
  ADD CONSTRAINT `id_s` FOREIGN KEY (`id_size`) REFERENCES `size` (`id`);
